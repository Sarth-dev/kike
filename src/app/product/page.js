...
async function getProduct(slug) {
  ...
  return {
    ...
    related: [
      { id: 'r1', name: 'Bluetooth Speaker', href: '/product/bluetooth-speaker', price: 59.99, image: '/Jordan KI.avif' },
      { id: 'r2', name: 'True Wireless Earbuds', href: '/product/tws-earbuds', price: 79.0, image: '/jordan OG.avif' },
      { id: 'r3', name: 'Protective Carry Case', href: '/product/headphone-case', price: 19.99, image: '/JordanHJ.avif' },
    ],
  };
}
...
export default function ProductPage({ params }) {
  ...
  return (
    ...
    <Navbar/>
      <section className="mx-auto max-w-7xl px-4 py-10">
      {/* Breadcrumbs */}
      <nav className="mb-4 text-sm text-gray-100" aria-label="Breadcrumb">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        {/* Details */}
        <div>
          <h1 className="text-2xl font-semibold text-gray-100">{p.name}</h1>
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <button
              onClick={addToCart}
              disabled={!p.inStock}
              className="rounded-md bg-orange-700 px-5 py-3 text-sm font-medium text-white hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-60"
            >
              Add to Cart
            </button>
            <button
